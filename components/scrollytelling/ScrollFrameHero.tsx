      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div className="relative z-10 mx-auto grid h-full max-w-7xl content-center px-5 pt-20 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
          <div className="max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.34em] text-[#D6A84F] sm:text-sm">
              Canvas Frame Sequence
            </p>
            <h1 className="mt-5 max-w-4xl text-[clamp(3.1rem,8vw,7.9rem)] font-semibold leading-[0.9] tracking-[-0.075em] text-[#F8F5EF]">
              Skalierbare Solar- und Speicherparks für die Energieinfrastruktur von morgen.
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-[#F8F5EF]/72 sm:text-xl">
